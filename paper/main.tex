...
% The ws-ijprai class prints a draft note (compile date, time, jobname) in
% the top-left corner of every page via \wsdraftnote. Remove it for submission.
\renewcommand{\wsdraftnote}{}

\begin{document}

\markboth{Kejie Hu}{Feedback-Controlled Diversity Regularization for Multi-Head Attention}
...
\address{City University of Wu Han, Wuhan Hubei 430083, CN\\
\email{xshu1999@gmail.com}}
...
\ref{app:h3ext}). Second, a strict paired
...
in \ref{app:sens}. The ceiling is a stability
...
\input{tables/tab1_fixed_lambda_h1}
...
\begin{figure}[t]
\centerline{\includegraphics[width=5in]{figures/fig1_h1_comparison.pdf}}
...
budget there (\ref{app:sens}).

\begin{figure}[t]
\centerline{\includegraphics[width=5in]{figures/fig2_trace_cora_seed3.pdf}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=5in]{figures/fig4_adaptive_baselines.pdf}}
...
\input{tables/tab4_adaptive_baselines}
...
(\ref{app:h3ext}) do not show this loss: B6 is at or above B4 in
...
\input{tables/tab3_h3_distill}

\begin{figure}[t]
\centerline{\includegraphics[width=4.2in]{figures/fig3_h3_distillation.pdf}}
...
\ref{app:sens} shows accuracy is stable across $(\eta, d^*)$ on
...
(Sec.~\ref{sec:h1},
\ref{app:sens}). Against adaptive baselines, the
...
\input{tables/tab6_revision_cis}

\section{Controller sensitivity to $\eta$ and $d^*$}
\label{app:sens}

\input{tables/tab7_sensitivity}

\section{H3 extension to Citeseer and Pubmed}
\label{app:h3ext}
